# Django settings for MyIsupMe project.
...
PROJECT_DIR, PROJECT_MODULE_NAME = os.path.split(
    os.path.dirname(os.path.realpath(MyIsupMe.__file__))
)
...
SECRET_KEY = 'ux!@-8*phnz@mb=r51&mgzmxy8$37fi8qf1e$4f@*bnfcnfhh7'
...
ROOT_URLCONF = 'MyIsupMe.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'MyIsupMe.wsgi.application'
